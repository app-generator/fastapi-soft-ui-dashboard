# [FastAPI Soft Dashboard](https://app-generator.dev/product/)

**FastAPI** project crafted on top of **Soft UI Dashboard**, an iconic `Bootstrap` Design from Creative-Tim.
